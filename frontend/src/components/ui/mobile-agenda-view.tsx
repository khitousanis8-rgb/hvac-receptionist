      ...
      <div className="rounded-xl border border-[#e7e7e7] bg-white p-2.5 shadow-xs">
        <div className="flex items-center justify-between px-1 pb-2 border-b border-[#f4f4f5]">
          <div className="flex items-center gap-1.5 text-[12px] font-semibold text-[#0a0a0a]">
            <CalendarIcon className="w-3.5 h-3.5 text-[#0b5ed7]" />
          ...
          {dateStrip.map((day) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={cn(
                    "text-[15px] font-semibold mt-0.5 leading-none",
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="inline-flex items-center gap-1 font-mono text-[12px] font-semibold text-[#0a0a0a] bg-[#f4f4f5] px-2 py-0.5 rounded-md border border-[#e7e7e7]">
